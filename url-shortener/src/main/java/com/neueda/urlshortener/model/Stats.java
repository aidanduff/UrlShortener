...
//		return numberOfUrlsShortened + " " + longestUrlShortened + " " + shortestUrlShortened + " " + serverStatus + " " + this.getServerUpTime();
//		"The server status is currently : " + serverStatus + "\n"
//		+ "The number of URLs submitted so far is : " + numberOfUrlsShortened + "\n"
//		+
//	}
